...
const SkillsForm = ({data , onChange}) => {
    ...
    const addSkill = () => {
        if(newSkill.trim() && !data.includes(setNewSkill.trim())){
            onChange([...data, setNewSkill.trim()])
            setNewSkill("")
        }
    }
    ...
    return (
        <div className='space-y-4'>
            ...
            <div className="flex gap-2">
                ...
                <button onClick={addSkill} disabled={!newSkill.trim} className='flex items-center gap-2 px-4 py-2 text-sm bg-blue-600 text-white rounded-lg 
            ...
            (
                <div className='text-center py-6 text-gray-500'>
                    ...
                    <p className="text-am">Add your technical and soft skills above.</p>
                </div>
        )}
