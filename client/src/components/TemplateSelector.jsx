...
const TemplateSelector = ({ selectedTemplate, onChange}) => {
    ...
    const template = [
        ...
        },
        {
            id: "modern",
            name: "Modern",
            preview: "slook design with strategiv use of color and modern font choices"
        },
         {
            id: "minimal-image",
            name: "Minimal Image",
                            ...
                            <div key={template.id} onClick={()=> {onChange(template.id);
                                ...
                                : "border-gray-300 hover:border-gray-400 hover:bg-gray-100"}`}>
                                    ...
                                    <div className="space-y-1">
                                        <h4 className='font-medium text-gray-80'>{template.name}</h4>
                                        <div className='t-2 p-2 bg-blue-50 rounded text-xs text-gray-500 italic'>{template.preview}</div>
                                        </div>
