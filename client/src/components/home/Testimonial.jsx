...
const Testimonial = () => {
    ...
    return (
        ...
        <Title title="Don't just take our words" description="Hear what our users say about us. We're always looking for ways to improve. If you have a positive esperience with us, leave a review.\" />
    </div>
    <style>{`
