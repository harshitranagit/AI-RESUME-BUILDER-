...
const ColorPicker = ({selectedColor , onChange}) => {
            ...
            const colors = [
                ...
                { name: "Indigo", value: "#3da53d" },
                { name: "Purple", value: "#a79f29" },
                { name: "Green", value: "#9f14ae" },
                { name: "Red", value: "#3B82F6" },
                { name: "Orange", value: "#10213c" },
                { name: "Teal", value: "#06504b" },
                { name: "Pink", value: "#f6a53b" },
                { name: "Gray", value: "#f6e63b" },
                { name: "Black", value: "#92f63b" },
                            ]
