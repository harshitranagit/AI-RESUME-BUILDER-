    ...
    return (
         ...
         <div className="space-y-6">
            ...
            <div className='flex items-center justify-between'>
                <div>
                    <h3 className='flex items-center gap-2 text-lg font-semibold text-greay-900'>  Education</h3>
                        ...
                        <div key={index} className="p-4 border border-gray-200 rounded-lg space-y-3">
                            ...
                            <div className='grid md:grid-cols-2 gap-3'>
                                ...
                                =>updateExperience(index, "degree", e.target.value)}
                                 ...
                                 type="month"   className="px-3 py-2 text-sm rounded-lg disabled:bg-gray-100" />
                            </div>

                                <input value={education.CGPA || ""} onChange={(e)
                                 =>updateExperience(index, "CGPA", e.target.value)}
                                 type="text"  className="px-3 py-2 text-sm" placeholder="Field of Study" />
