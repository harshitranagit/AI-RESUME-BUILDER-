...
import PresonalInfoForm from "../components/PersonalInfoForm";
                        ...
                        <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
                            ...
                            <div className="flex justify-between items-center mb-6 border-b border-gray-300 py-1">
                                ...
                                <div className="flex items-center">
                                    {activeSectionIndex !== 0 && (
                                     ...
                                     <button onClick={()=> setActiveSectionIndex((prevIndex)=>Math.min(prevIndex  + 1 , sections.length  - 1))} className={`flex items-center gap-1 p-3 rounded-lg text-sm font-medium text-greay-600 hover:bg-gray-50 transition-all $ {activeSectionIndex === sections.length - 1 &&  'opacity-50'   }`} 
                            ...
                            <div className='space-y-6'>
                                {activeSection.id === 'personal' && (
                                    <PresonalInfoForm data={resumeData.personal_info} OnChange={(data)=>setResumeData(prev => ({...prev, personal_info:data}))} removeBackground={removeBackground} setRemoveBackground={setRemoveBackground}/>
                                )}
                                {activeSection.id === 'summary' && (
                                    <ProfessionalSummaryForm data={resumeData.professional_summary} onChange={(data)=> setResumeData(prev=> ({...prev,
